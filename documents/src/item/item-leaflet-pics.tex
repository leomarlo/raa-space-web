%% ══════════════════════════════════════════════════════════
%%  ITEM — Shuffled Time · Header Playground (full leaflet)
%%  Compile: pdflatex item-leaflet-pics.tex  (run twice)
%% ══════════════════════════════════════════════════════════
...
%% Time badge: filled with theme colour, black bold text
\newcommand{\timebadge}[1]{%
  {%
    \setlength{\fboxsep}{2.5pt}%
    \colorbox{raared}{\footnotesize\bfseries\strut #1}%
  }%
}

%% ── HEADER MACROS ──────────────────────────────────────────────────────────
%% Left 2/5: date · 2 reserved name lines · time badge · group visit
%% Right 3/5: pic(s) flush-right
%% Pic height = 2.4cm to reach top of date

%% soloheader — 1 pic, short name (phantom reserves 2nd name line)
%% {date}{artist + country}{coretime}{groupvisit}{picpath}
\newcommand{\soloheader}[5]{%
  \noindent%
  \begin{minipage}[t]{0.38\linewidth}%
    \vspace{0pt}%
    \setlength{\parskip}{0pt}%
    {\footnotesize\bfseries#1}\\[2pt]%
    {\small\bfseries\itshape#2}\\%
    {\small\phantom{Mg}}\\[3pt]%
    \timebadge{#3}\\[2pt]%
    {\footnotesize\bfseries Group Visit:\upshape~#4}%
  \end{minipage}%
  \hfill%
  \begin{minipage}[t]{0.58\linewidth}%
    \vspace{0pt}%
    \setlength{\parskip}{0pt}%
    \hfill\picframe{\includegraphics[height=2.4cm,keepaspectratio=true]{#5}}%
  \end{minipage}%
  \par\vspace{3pt}%
}

%% longsoloheader — 1 pic, name wraps to 2 lines naturally (no phantom)
%% {date}{artist + country}{coretime}{groupvisit}{picpath}
\newcommand{\longsoloheader}[5]{%
  \noindent%
  \begin{minipage}[t]{0.38\linewidth}%
    \vspace{0pt}%
    \setlength{\parskip}{0pt}%
    {\footnotesize\bfseries#1}\\[2pt]%
    {\small\bfseries\itshape#2}\\[3pt]%
    \timebadge{#3}\\[2pt]%
    {\footnotesize\bfseries Group Visit:\upshape~#4}%
  \end{minipage}%
  \hfill%
...
%% duoheader — 2 pics, long name wraps to 2 lines naturally (no phantom)
%% {date}{artists + countries}{coretime}{groupvisit}{pic1}{pic2}
\newcommand{\duoheader}[6]{%
  \noindent%
  \begin{minipage}[t]{0.38\linewidth}%
    \vspace{0pt}%
    \setlength{\parskip}{0pt}%
  ...
  \begin{minipage}[t]{0.58\linewidth}%
    ...
    \setlength{\parskip}{0pt}%
    \hfill%
    \picframe{\includegraphics[height=2.4cm,keepaspectratio=true]{#5}}%
    \hspace{1.5mm}%
    \picframe{\includegraphics[height=2.4cm,keepaspectratio=true]{#6}}%
  \end{minipage}%
  \par\vspace{3pt}%
}
...
\begin{center}
  ...
  {\small
   ...
   \href{https://raa.space/donations}{\texttt{raa.space/donations}}}
\end{center}
...
\begin{tabular*}{\textwidth}{@{}l@{\enspace}l@{\extracolsep{\fill}}r@{}}
MON & \textbf{NOW} — Maruta Gredzena                        & \textit{iii}\\
THU & \textbf{Presence in Absence Piece Three} — Lisette Ros & \textit{v}\\
TUE & \textbf{N.3} — Ernests Ā                             & \textit{vii}\\
SUN & \textbf{Words to Change the World} — Ilze Aulmane     & \textit{ix}\\
WED & \textbf{Gluttony} — K.\,Šuksta \& S.\,Muriņš         & \textit{xi}\\
FRI & \textbf{Time Scores} — Vanessa Brzić                  & \textit{xiii}\\
SAT & \textbf{Laiks Telpā} — Ilze Mazpane \& Jana Zariņa   & \textit{xv}\\
\end{tabular*}
}

%% ══════════════════════════════════════════════════════════
%%  iii–iv  NOW — Maruta Gredzena  (Mon 6.07)
%% ══════════════════════════════════════════════════════════
\newpage
...
\newpage
\newgeometry{top=0.4cm,bottom=0.4cm,left=0.2cm,right=0.8cm}
\descpagebg

\soloheader%
  {Monday, 6 July 2026}%
  {Maruta Gredzena~{\normalfont\footnotesize(LV)}}%
  {17:00\,–\,22:00}%
  {19:00}%
  {\assets/06_7_now/profile.png}
...
\noindent{\footnotesize\color{mygray}%
  \href{https://raa.space/item/now}{\texttt{raa.space/item/now}}\hfill\thepage}

%% ══════════════════════════════════════════════════════════
%%  v–vi  PRESENCE IN ABSENCE PIECE THREE — Lisette Ros  (Thu 9.07)
%% ══════════════════════════════════════════════════════════
\newpage
\newgeometry{top=0cm,bottom=0cm,left=0cm,right=0cm}
...
\soloheader%
  ...
  {Lisette Ros~{\normalfont\footnotesize(NL)}}%
  {16:00\,–\,open end}%
  {18:00}%
  {\assets/09_7_presenceinabsencepiece3/LisetteRos.png}
...
%% ══════════════════════════════════════════════════════════
%%  vii–viii  N.3 — Ernests Ā  (Tue 7.07)
%%  Pic crop: 1/5 top + 1/5 bottom (1920×1/5 = 384bp at 72dpi)
%% ══════════════════════════════════════════════════════════
\newpage
\newgeometry{top=0cm,bottom=0cm,left=0cm,right=0cm}
...
%% Inline header — cropped pic passed directly to \picframe
\noindent%
\begin{minipage}[t]{0.38\linewidth}%
  \vspace{0pt}%
  \setlength{\parskip}{0pt}%
  {\footnotesize\bfseries Tuesday, 7 July 2026}\\[2pt]%
  {\small\bfseries\itshape Ernests Ā~{\normalfont\footnotesize(LV)}}\\%
  {\small\phantom{Mg}}\\[3pt]%
  \timebadge{18:00\,–\,open end}\\[2pt]%
  {\footnotesize\bfseries Group Visit:\upshape~19:00}%
\end{minipage}%
\hfill%
\begin{minipage}[t]{0.58\linewidth}%
  \vspace{0pt}%
  \setlength{\parskip}{0pt}%
  \hfill\picframe{\includegraphics[trim={0bp 384bp 0bp 384bp},clip=true,%
    height=2.4cm,keepaspectratio=true]{\assets/07_7_N.3/ernests.jpeg}}%
\end{minipage}%
\par\vspace{3pt}%
...
%% ══════════════════════════════════════════════════════════
%%  ix–x  WORDS TO CHANGE THE WORLD — Ilze Aulmane  (Sun 5.07)
%%  "30 min." on 2nd name line → removed from description body
%% ══════════════════════════════════════════════════════════
\newpage
\newgeometry{top=0cm,bottom=0cm,left=0cm,right=0cm}
...
\longsoloheader%
  {Sunday, 5 July 2026}%
  {Ilze Aulmane~{\normalfont\footnotesize(LV)}\\ 30 min.}%
  {19:00\,–\,20:30}%
  {19:30}%
  {\assets/05_7_words_to_change_the_world/profile.jpeg}
...
%% ══════════════════════════════════════════════════════════
%%  xi–xii  GLUTTONY — Kristiāna Šuksta & Sandris Muriņš  (Wed 8.07)
%%  Duo header: both photos. Kristiāna centre-portrait crop 1/4 each side.
%%  (678×452 @ 72dpi → 678bp wide; trim 169bp each side → 340×452bp portrait)
%% ══════════════════════════════════════════════════════════
\newpage
\newgeometry{top=0cm,bottom=0cm,left=0cm,right=0cm}
...
%% Inline duo header — Kristiāna needs crop, Sandris as-is
\noindent%
\begin{minipage}[t]{0.38\linewidth}%
  \vspace{0pt}%
  \setlength{\parskip}{0pt}%
  {\footnotesize\bfseries Wednesday, 8 July 2026}\\[2pt]%
  {\small\bfseries\itshape Kristiāna Šuksta \& Sandris Muriņš~{\normalfont\footnotesize(LV)}}\\[3pt]%
  \timebadge{18:00\,–\,22:00}\\[2pt]%
  {\footnotesize\bfseries Group Visit:\upshape~20:00}%
\end{minipage}%
\hfill%
\begin{minipage}[t]{0.58\linewidth}%
  \vspace{0pt}%
  \setlength{\parskip}{0pt}%
  \hfill%
  \picframe{\includegraphics[trim={169bp 0bp 169bp 0bp},clip=true,%
    height=2.4cm,keepaspectratio=true]{\assets/08_7_gluttony/kristianasuksta.jpg}}%
  \hspace{1.5mm}%
  \picframe{\includegraphics[height=2.4cm,keepaspectratio=true]%
    {\assets/08_7_gluttony/sandrismurins.jpeg}}%
\end{minipage}%
\par\vspace{3pt}%
...
live performance to explore personal experience and human relationships with wit
and humour, inviting viewers to reflect while maintaining a sense of lightness.
}
...
%% ══════════════════════════════════════════════════════════
%%  xiii–xiv  TIME SCORES — Vanessa Brzić  (Fri 10.07)
%% ══════════════════════════════════════════════════════════
\newpage
\newgeometry{top=0cm,bottom=0cm,left=0cm,right=0cm}
...
\soloheader%
  {Friday, 10 July 2026}%
  {Vanessa Brzić~{\normalfont\footnotesize(HR)}}%
  {18:00\,–\,21:00}%
  {19:00}%
  {\assets/10_7_timescores/vanessa.jpg}
...
%% ══════════════════════════════════════════════════════════
%%  xv–xvi  LAIKS TELPĀ — Ilze Mazpane & Jana Zariņa  (Sat 11.07)
%%  Ilze: landscape 6960×4640 @ 300dpi (1670.4×1113.6bp)
%%    Side trim 5/16 each + top/bottom 1/4 each:
%%    trim={522bp 278bp 522bp 278bp} → 626×558bp (nearly square)
%%  Jana: 180×280 @ 72dpi → 1/7 top (40bp) + 1/4 bottom (70bp):
%%    trim={0bp 70bp 0bp 40bp} → 180×170bp (nearly square)
%% ══════════════════════════════════════════════════════════
\newpage
\newgeometry{top=0cm,bottom=0cm,left=0cm,right=0cm}
...
%% Inline duo header — both pics cropped
\noindent%
\begin{minipage}[t]{0.38\linewidth}%
  \vspace{0pt}%
  \setlength{\parskip}{0pt}%
  {\footnotesize\bfseries Saturday, 11 July 2026}\\[2pt]%
  {\small\bfseries\itshape Ilze Mazpane \& Jana Zariņa~{\normalfont\footnotesize(LV)}}\\[3pt]%
  \timebadge{16:00\,–\,open end}\\[2pt]%
  {\footnotesize\bfseries Group Visit:\upshape~18:00}%
\end{minipage}%
\hfill%
\begin{minipage}[t]{0.58\linewidth}%
  \vspace{0pt}%
  \setlength{\parskip}{0pt}%
  \hfill%
  \picframe{\includegraphics[trim={522bp 278bp 522bp 278bp},clip=true,%
    height=2.4cm,keepaspectratio=true]%
    {\assets/11_7_laikstelpa/ilze_bw_dip_portreti_9.jpg}}%
  \hspace{1.5mm}%
  \picframe{\includegraphics[trim={0bp 70bp 0bp 40bp},clip=true,%
    height=2.4cm,keepaspectratio=true]%
    {\assets/11_7_laikstelpa/JanaZarina.jpeg}}%
\end{minipage}%
\par\vspace{3pt}%
...
site-specific durational works marked by poetic sensibility and a sensitive
relationship with space.

\vspace{3pt}
\textbf{Jana Zariņa} is primarily a historical keyboard and sound artist whose work
spans early music, contemporary improvisation, electro-acoustic performance and
...
%% ══════════════════════════════════════════════════════════
%%  xvii–xviii  NOTES  (watermark only)
%% ══════════════════════════════════════════════════════════
\newpage
\newgeometry{top=0.4cm,bottom=0.4cm,left=0.5cm,right=0.5cm}
\descpagebg
\sectiontitle{NOTES}
\vfill
\noindent{\footnotesize\color{mygray}\hfill\thepage}
