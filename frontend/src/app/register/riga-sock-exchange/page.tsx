...
export default function RigaSockExchangePage() {
    const [navOpen, setNavOpen] = useState(false);
    const { t } = useLanguage();

    const event = t.program.items.rigaSockExchange;
    const regForm1stOfSeptember: RegisterFormProps = {
      title: t.program.items.rigaSockExchange.title,
      description: t.program.items.rigaSockExchange.shortDescription,
      placeholder: t.registerWorkshop.placeholder,
      submit: `${event.registerForRigaSockExchange}. ${event.times}`,
    };
