...
export default function HandsAndBrainTournamentPage() {
  const [navOpen, setNavOpen] = useState(false);
  const { t } = useLanguage();
  const event = t.program.items.handsAndBrainTournament;
  const eventForPage = {
    ...event,
    image: '/assets/hands-and-brain-tournament/poster-mid.png',
  };
