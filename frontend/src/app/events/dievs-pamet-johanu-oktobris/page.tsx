...
export default function DievsPametJohanuOktobrisPage() {
  ...
  return (
    <div className="relative w-full min-h-screen text-[#f5f5dc]">
      ...
      <div className="relative z-10 py-20 px-4 sm:px-8 pointer-events-auto flex justify-center">
        <EventPageContent event={t.program.items.dievsPametJohanuOktobris}>
          <EventLinks event={t.program.items.dievsPametJohanuOktobris} />
        </EventPageContent>
      </div>
    </div>
  );
